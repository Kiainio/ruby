...
class TransactionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_item" do
    assert_difference('TransactionItem.count') do
      post transaction_items_url, params: { transaction_item: { cart_item_id: @transaction_item.cart_item_id, price: @transaction_item.price } }
    end
  ...
  test "should update transaction_item" do
    patch transaction_item_url(@transaction_item), params: { transaction_item: { cart_item_id: @transaction_item.cart_item_id, price: @transaction_item.price } }
