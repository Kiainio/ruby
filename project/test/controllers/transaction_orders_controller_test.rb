...
class TransactionOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_order" do
    assert_difference('TransactionOrder.count') do
      post transaction_orders_url, params: { transaction_order: { deal_sum: @transaction_order.deal_sum, delivery_address: @transaction_order.delivery_address, delivery_name: @transaction_order.delivery_name, delivery_phone: @transaction_order.delivery_phone, delivery_postcode: @transaction_order.delivery_postcode, order_status: @transaction_order.order_status } }
    end
  ...
  test "should update transaction_order" do
    patch transaction_order_url(@transaction_order), params: { transaction_order: { deal_sum: @transaction_order.deal_sum, delivery_address: @transaction_order.delivery_address, delivery_name: @transaction_order.delivery_name, delivery_phone: @transaction_order.delivery_phone, delivery_postcode: @transaction_order.delivery_postcode, order_status: @transaction_order.order_status } }
